  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Banter.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Banter.Accounts.Token
      signing_secret Banter.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Banter.Accounts.User.Senders.SendPasswordResetEmail
